...
import Adapter.MyAdapterHistory;
...
public class FragmentIsPromotion extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        myView = mLayoutInflater.inflate(R.layout.fragment_3_layout, mContainer, false);
    ...
    private void setDetail(){
        ...
        String url = getIPAPI.IPAddress + "/history/data.php?branchID=" + users.branchID + "&dates=" + dates_current + "&branchGroupID=" + users.branchGroup;
    ...
    class MyAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    items.add(new CustomItemHistory(id,jsonObj.getString("PromotionName"), start,end,sTimeStart,sTimeEnd,createBy,jsonObj.getString("BranchID")));
        ...
        protected void onPostExecute(String s) {
            ...
            myAdapter = new MyAdapterHistory(getActivity(),items);
