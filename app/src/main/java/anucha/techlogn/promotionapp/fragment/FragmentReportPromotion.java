...
import Adapter.MyAdapterReport;
...
public class FragmentReportPromotion extends Fragment {
    ...
    private MyAdapterReport myAdapter;
    ArrayList items;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        myView = mLayoutInflater.inflate(R.layout.fragment_4_layout, mContainer, false);
    ...
    class MyAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    items.add(new CustomItemReport(Integer.parseInt(jsonObj.getString("PromotionID")),jsonObj.getString("PromotionName"),
                            jsonObj.getString("IsActives"), start,end,sTimeStart,sTimeEnd,createBy,jsonObj.getString("Num"),jsonObj.getString("Total")));
        ...
        protected void onPostExecute(String s) {
            ...
            myAdapter = new MyAdapterReport(getActivity(),items);
